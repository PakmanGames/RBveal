              ...
              <Collapsible>
                ...
                <CollapsibleContent className="mt-4 space-y-4 rounded-lg border bg-gray-50 p-4 text-sm">
                  <p>
                    ...
                    email or text message notification to the Interac e-Transfer
                    recipient at the email address or mobile number that you
                    provide. The email or text message notification will
                    identify you as the sender and contain the Interac Transfer
                    amount, the name of the Interac e-Transfer recipient, and
                    that you are using Interac e-Transfer.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    service, are entitled to pay an Interac e-Transfer to anyone
                    who, in using Online or Mobile Banking, or the online or
                    mobile banking service of another financial institution,
                    claims the Interac e-Transfer and where applicable,
                    correctly responds to the Interac e-Transfer question,
                    whether you intended that person to receive the Interac
                    e-Transfer or not.
                  </p>
                  <p>
                    You are responsible for providing a correct and operational
                    email address and/or mobile number for the Interac
                    e-Transfer recipient and for notifying us promptly of any
                    change to the email address or mobile number of the Interac
                    e-Transfer recipient.
                  </p>
                  <p>
                    Interac keeps only one question and answer per recipient on
                    file. If you change the question or answer for a recipient,
                    the new question or answer will override any previous ones
                    submitted for that recipient. It will allow them to accept
                    all outstanding Interac e-Transfers from the sender that
                    have not yet been cancelled. If there is an outstanding
                    Interac e-Transfer you do not wish a recipient to receive,
                    you must cancel it via Online or Mobile Banking before it is
                    accepted.
                  </p>
