            ...
            <CardContent className="flex items-center gap-6 p-6">
              ...
              <div>
                <h2 className="mb-2 text-lg font-semibold">
                  Get a Higher Interac e-Transfer Limit with the RBC Mobile App
                </h2>
                <p className="mb-2 text-sm text-gray-600">
                  Use your RBC Mobile app to securely send above your current
                  Online Banking $1,000 Interac e-Transfer daily limit. You can
                  send up to $10,000 per day from your mobile device when you
              ...
              <CardContent className="p-6">
                <div className="flex gap-4">
                  ...
                  <div className="space-y-4 text-sm">
                    ...
                    <p>
                      Once confirmed, funds are immediately withdrawn from your
                      account. A service fee may also apply. You can cancel an
                      Interac e-Transfer after you have sent it, unless the
                      recipient has accepted the money. To cancel an Interac
                      e-Transfer, go to the Payment History page and click on
                      the hyperlink.
                    </p>
                    <p>
                      Notifications regarding your Interac e-Transfer will be
                      sent to your Message Centre. Please review new messages on
                      a regular basis.If you do not cancel an unclaimed Interac
                      e-Transfer within 15 calendar days after we've notified
                      you of its expiry, we will return the funds to your
                      account and apply a reclaim fee.
                    </p>
                    <p>
                      You're responsible for providing a correct and operational
