        ...
        <div className="flex-1 p-6">
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mb-6 text-sm text-gray-600">
              Before sending, double check the amount and contact details are
              correct.
            </p>
              ...
              <CardContent className="flex items-center gap-6 p-6">
                ...
                <div>
                  <h2 className="mb-2 text-lg font-semibold">
                    Get a Higher Interac e-Transfer Limit with the RBC Mobile
                    App
                  </h2>
                  <p className="mb-2 text-sm text-gray-600">
                    Use your RBC Mobile app to securely send above your current
                    Online Banking $1,000 Interac e-Transfer daily limit. You
                    can send up to $10,000 per day from your mobile device when
                    you successfully verify your identity.{" "}
                    <Link href="#" className="text-blue-600 hover:underline">
                      Learn more about 2-Step Verification
                    </Link>
                  </p>
                  <Link href="#" className="text-blue-600 hover:underline">
                    How To Get the RBC Mobile App
                  </Link>
                </div>
              </CardContent>
            </Card>
            ...
            <form className="space-y-8">
              ...
              <div>
                ...
                <div className="grid gap-4">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <Label>To</Label>
                    <div className="col-span-2">RBC Bank</div>
                  </div>
                  <div className="grid grid-cols-3 gap-4">
                    <Label>Amount</Label>
                    <div className="col-span-2">$1000.00</div>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs text-gray-500">
                      3-25 characters, no spaces or special characters
                    </p>
                  </div>
                  <div>
                    <Label htmlFor="security-answer-confirm">
              ...
              <div>
                ...
                <p className="mb-4 text-sm text-gray-600">
                  Please do not include the security question and answer in this
                  message
                </p>
              ...
              <div className="rounded-lg bg-yellow-50 p-4 text-sm">
                <p>
                  You may be required to verify your identity using 2-Step
                  Verification. For more information, visit the{" "}
                  <Link href="#" className="text-blue-600 hover:underline">
                    FAQ page
                  </Link>
                </p>
                ...
                <CardContent className="p-6">
                  <div className="flex gap-4">
                    ...
                    <div className="space-y-4 text-sm">
                      ...
                      <p>
                        Once confirmed, funds are immediately withdrawn from
                        your account. A service fee may also apply. You can
                        cancel an Interac e-Transfer after you have sent it,
                        unless the recipient has accepted the money. To cancel
                        an Interac e-Transfer, go to the Payment History page
                        and click on the hyperlink.
                      </p>
                      <p>
                        Notifications regarding your Interac e-Transfer will be
                        sent to your Message Centre. Please review new messages
                        on a regular basis.If you do not cancel an unclaimed
                        Interac e-Transfer within 15 calendar days after we've
                        notified you of its expiry, we will return the funds to
                        your account and apply a reclaim fee.
                      </p>
                      <p>
                        You're responsible for providing a correct and
                        operational email address and/or mobile number for the
                        Interac e-Transfer recipient.
                      </p>
                      <p className="text-gray-500">
                        Additional text message or data charges may apply for
                        the recipient depending on their carrier and/or plan.
                      </p>
                    </div>
                  </div>
                </CardContent>
